...
(function ($) {
	jQuery(window).load(function() {
		...
		var navHtml = '<ul class="flex-direction-nav">' +
			'<li class="flex-nav-prev"><a class="flex-prev button">' + astra.checkout_prev_text + '</a></li>' +
			'<li class="flex-nav-next"><a class="flex-next button">' + astra.checkout_next_text + '</a></li>' +
			'</ul>';
